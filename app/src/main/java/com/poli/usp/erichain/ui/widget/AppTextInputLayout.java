package com.poli.usp.erichain.ui.widget;
...
import com.poli.usp.erichain.utils.TextMask;
import com.poli.usp.erichain.utils.validations.IsCpf;
import com.poli.usp.erichain.utils.validations.IsEmail;
    ...
    private void setInputType() {
        ...
        switch (mInputType) {
            ...
            case TYPE_PHONE:
                ...
                break;
            default:
                System.out.println("No identified data type.");
                break;
        }
        if(!mMask.isEmpty()){
